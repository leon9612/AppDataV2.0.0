        ...
        <div class="container">
            ...
            <div class="row" data-aos="fade-in">
                ...
                <div class="col-lg-12 mt-12 mt-lg-12 d-flex align-items-stretch">
                    <form action="<?php echo e(url('/cal')); ?>" method="POST" class="form-control" id="form-calibracion">
                        <?php echo csrf_field(); ?>
                                ...
                                <div class="col-sm-12 col-md-2 col-lg-2" style="align-content: center">
                                    <div class="input-group mb-3" style="align-content: center">
                                        ...
                                        <input type="number" step="0.001" class="form-control" name="PEF"
                                            id="PEF" value="<?php echo e(old('PEF')); ?>" placeholder="PEF">
...
<?php /**PATH C:\Apache248\htdocs\AppData\resources\views/Vcalibracion.blade.php ENDPATH**/ ?>