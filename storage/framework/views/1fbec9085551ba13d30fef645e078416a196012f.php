        ...
        <div class="container">
            ...
            <div class="row" data-aos="fade-in">
                ...
                <div class="col-lg-12 mt-12 mt-lg-12 d-flex align-items-stretch">
                    <form action="<?php echo e(url('/gam')); ?>" method="POST" class="form-control">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-3 col-lg-3" style="align-content: center">
                                <div class="input-group mb-3" style="align-content: center">
                                    ...
                                    <?php if($errors->has('selScooter')): ?>
                                    <span class="error text-danger"><?php echo e($errors->first('selScooter')); ?></span>
                                    <?php endif; ?>
                                    ...
                                    <div class="col-sm-12 col-md-4 col-lg-4" style="align-content: center">
                                        <div class="input-group mb-3" style="align-content: center">
                                            <div class="form-floating mb-3">
                                                ...
                                                <span
                                                    class="error text-danger"><?php echo e($errors->first('tempAmbiente')); ?></span>
                                                <?php endif; ?>
                                            </div>
                                ...
                                <div class="input-group mb-3">
                                    <div class="form-floating mb-3" style="margin-top: 29px">
                                        <input type="number" class="form-control" step="0.01" name="tempMotor"
                                            id="tempMotor" placeholder="1" value="<?php echo e($tempMotor); ?>">
...
</script><?php /**PATH C:\Apache248\htdocs\AppData\resources\views/TipoPrueba/gasesmotos.blade.php ENDPATH**/ ?>