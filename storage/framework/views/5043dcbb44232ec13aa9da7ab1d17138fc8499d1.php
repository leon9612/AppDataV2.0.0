        ...
        <div class="container">
            ...
            <div class="row" data-aos="fade-in">
                <div class="col-lg-12 mt-12 mt-lg-12 d-flex align-items-stretch">
                    <form action="<?php echo e(url('/frm')); ?>" method="POST" class="form-control">
                        <?php echo csrf_field(); ?>
                                    ...
                                    <div class="col-sm-12 col-md-3 col-lg-3">
                                        <div class="mb-1">
                                            <input type="text" class="form-control" name="fuerza1d" id="fuerza1d"
                                                placeholder="Freno eje 1" value="<?php echo e(old('fuerza1d')); ?>">
                                    ...
                                    <div class="col-sm-12 col-md-3 col-lg-3">
                                        <div class="mb-1">
                                            <input type="number" class="form-control" step="0.01" name="fuerza1i"
                                                id="fuerza1i" placeholder="Freno eje 1" value="<?php echo e(old('fuerza1i')); ?>">
                                    ...
                                    <div class="col-sm-12 col-md-2 col-lg-2" style="align-content: center">
                                        <div class="mb-1">
                                            <input type="number" class="form-control" placeholder="Eficacia total"
                                                name="efitotal" id="efitotal" value="<?php echo e(old('efitotal')); ?>" disabled>
...
</script><?php /**PATH C:\Apache248\htdocs\AppData\resources\views/TipoPrueba/frenomotos.blade.php ENDPATH**/ ?>