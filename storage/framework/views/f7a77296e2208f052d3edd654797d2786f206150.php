        ...
        <div class="container">
            ...
            <div class="row" data-aos="fade-in">
                ...
                <div class="col-lg-12 mt-12 mt-lg-12 d-flex align-items-stretch">
                    <form action="<?php echo e(url('/lu')); ?>" method="POST" class="form-control">
                        <?php echo csrf_field(); ?>
                                            ...
                                            <div class="input-group mb-3" style="align-content: center">
                                                <div class="form-floating mb-3">
                                                    <input type="text" class="form-control" name="baja_derecha"
                                                        ...
                                                        value="<?php echo e(old('baja_derecha')); ?>">
                                                    <label for="floatingInput">BAJA D</label>
                                                    <?php if($errors->has('baja_derecha')): ?>
                                                    <span
                                                        class="error text-danger"><?php echo e($errors->first('baja_derecha')); ?></span>
                                                    <?php endif; ?>
                                                </div>
                                            ...
                                            <div class="input-group mb-3" style="align-content: center">
                                                <div class="form-floating mb-3">
                                                    <input type="number" class="form-control" step="0.01"
                                                        ...
                                                        value="<?php echo e(old('baja_izquierda')); ?>">
                                                    <label for="floatingInput">BAJA I</label>
                                                    <?php if($errors->has('baja_izquierda')): ?>
                                                    <span
                                                        class="error text-danger"><?php echo e($errors->first('baja_izquierda')); ?></span>
                                                    <?php endif; ?>
                                                </div>
                                            ...
                                            <div class="input-group mb-3" style="align-content: center">
                                                <div class="form-floating mb-3">
                                                    <input type="text" class="form-control" name="baja_derecha_1"
                                                        ...
                                                        value="<?php echo e(old('baja_derecha_1')); ?>">
                                                    <label for="floatingInput">BAJA D-1</label>
                                                    <?php if($errors->has('baja_derecha_1')): ?>
                                                    <span
                                                        class="error text-danger"><?php echo e($errors->first('baja_derecha_1')); ?></span>
                                                    <?php endif; ?>
                                                </div>
                                            ...
                                            <div class="input-group mb-3" style="align-content: center">
                                                <div class="form-floating mb-3">
                                                    <input type="number" class="form-control" step="0.01"
                                                        ...
                                                        value="<?php echo e(old('baja_izquierda_1')); ?>">
                                                    <label for="floatingInput">BAJA I-1</label>
                                                    <?php if($errors->has('baja_izquierda_1')): ?>
                                                    <span
                                                        class="error text-danger"><?php echo e($errors->first('baja_izquierda_1')); ?></span>
                                                    <?php endif; ?>
                                                </div>
                                            ...
                                            <div class="input-group mb-3" style="align-content: center">
                                                <div class="form-floating mb-3">
                                                    <input type="text" class="form-control" name="alta_derecha"
                                                        ...
                                                        value="<?php echo e(old('alta_derecha')); ?>">
                                                    <label for="floatingInput">ALTA D</label>
                                                    <?php if($errors->has('alta_derecha')): ?>
                                                    <span
                                                        class="error text-danger"><?php echo e($errors->first('alta_derecha')); ?></span>
                                                    <?php endif; ?>
                                                </div>
                                            ...
                                            <div class="input-group mb-3" style="align-content: center">
                                                <div class="form-floating mb-3">
                                                    <input type="number" class="form-control" step="0.01"
                                                        ...
                                                        value="<?php echo e(old('alta_izquierda')); ?>">
                                                    <label for="floatingInput">ALTA I</label>
                                                    <?php if($errors->has('alta_izquierda')): ?>
                                                    <span
                                                        class="error text-danger"><?php echo e($errors->first('alta_izquierda')); ?></span>
                                                    <?php endif; ?>
                                                </div>
                                            ...
                                            <div class="input-group mb-3" style="align-content: center">
                                                <div class="form-floating mb-3">
                                                    <input type="text" class="form-control" name="alta_derecha_1"
                                                        ...
                                                        value="<?php echo e(old('alta_derecha_1')); ?>">
                                                    <label for="floatingInput">ALTA D-1</label>
                                                    <?php if($errors->has('alta_derecha_1')): ?>
                                                    <span
                                                        class="error text-danger"><?php echo e($errors->first('alta_derecha_1')); ?></span>
                                                    <?php endif; ?>
                                                </div>
                                            ...
                                            <div class="input-group mb-3" style="align-content: center">
                                                <div class="form-floating mb-3">
                                                    <input type="number" class="form-control" step="0.01"
                                                        ...
                                                        value="<?php echo e(old('alta_izquierda_1')); ?>">
                                                    <label for="floatingInput">ALTA I-1</label>
                                                    <?php if($errors->has('alta_izquierda_1')): ?>
                                                    <span
                                                        class="error text-danger"><?php echo e($errors->first('alta_izquierda_1')); ?></span>
                                                    <?php endif; ?>
                                                </div>
                                        ...
                                        <div class="input-group mb-3" style="align-content: center">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" name="anti_derecha"
                                                    id="anti_derecha" placeholder="1" value="<?php echo e(old('anti_derecha')); ?>">
                                                <label for="floatingInput">ANTI D</label>
                                                <?php if($errors->has('anti_derecha')): ?>
                                                <span
                                                    class="error text-danger"><?php echo e($errors->first('anti_derecha')); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="input-group mb-3" style="align-content: center">
                                            <div class="form-floating mb-3">
                                                <input type="number" class="form-control" step="0.01"
                                                    ...
                                                    value="<?php echo e(old('anti_izquierda')); ?>">
                                                <label for="floatingInput">ANTI I</label>
                                                <?php if($errors->has('anti_izquierda')): ?>
                                                <span
                                                    class="error text-danger"><?php echo e($errors->first('anti_izquierda')); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="input-group mb-3" style="align-content: center">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" name="anti_derecha_1"
                                                    ...
                                                    value="<?php echo e(old('anti_derecha_1')); ?>">
                                                <label for="floatingInput">ANTI D-1</label>
                                                <?php if($errors->has('anti_derecha_1')): ?>
                                                <span
                                                    class="error text-danger"><?php echo e($errors->first('anti_derecha_1')); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="input-group mb-3" style="align-content: center">
                                            <div class="form-floating mb-3">
                                                <input type="number" class="form-control" step="0.01"
                                                    ...
                                                    value="<?php echo e(old('anti_izquierda_1')); ?>">
                                                <label for="floatingInput">ANTI I-1</label>
                                                <?php if($errors->has('anti_izquierda_1')): ?>
                                                <span
                                                    class="error text-danger"><?php echo e($errors->first('anti_izquierda_1')); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="input-group mb-3" style="align-content: center">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" name="anti_derecha_2"
                                                    ...
                                                    value="<?php echo e(old('anti_derecha_2')); ?>">
                                                <label for="floatingInput">ANTI D-2</label>
                                                <?php if($errors->has('anti_derecha_2')): ?>
                                                <span
                                                    class="error text-danger"><?php echo e($errors->first('anti_derecha_2')); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="input-group mb-3" style="align-content: center">
                                            <div class="form-floating mb-3">
                                                <input type="number" class="form-control" step="0.01"
                                                    ...
                                                    value="<?php echo e(old('anti_izquierda_2')); ?>">
                                                <label for="floatingInput">ANTI I-2</label>
                                                <?php if($errors->has('anti_izquierda_2')): ?>
                                                <span
                                                    class="error text-danger"><?php echo e($errors->first('anti_izquierda_2')); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="input-group mb-3" style="align-content: center">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" name="anti_derecha_3"
                                                    ...
                                                    value="<?php echo e(old('anti_derecha_3')); ?>">
                                                <label for="floatingInput">ANTI D-3</label>
                                                <?php if($errors->has('anti_derecha_3')): ?>
                                                <span
                                                    class="error text-danger"><?php echo e($errors->first('anti_derecha_3')); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="input-group mb-3" style="align-content: center">
                                            <div class="form-floating mb-3">
                                                <input type="number" class="form-control" step="0.01"
                                                    ...
                                                    value="<?php echo e(old('anti_izquierda_3')); ?>">
                                                <label for="floatingInput">ANTI I-3</label>
                                                <?php if($errors->has('anti_izquierda_3')): ?>
                                                <span
                                                    class="error text-danger"><?php echo e($errors->first('anti_izquierda_3')); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="input-group mb-3" style="align-content: center">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" name="incli_derecha"
                                                    ...
                                                    value="<?php echo e(old('incli_derecha')); ?>">
                                                <label for="floatingInput">INCLI D</label>
                                                <?php if($errors->has('incli_derecha')): ?>
                                                <span
                                                    class="error text-danger"><?php echo e($errors->first('incli_derecha')); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="input-group mb-3" style="align-content: center">
                                            <div class="form-floating mb-3">
                                                <input type="number" class="form-control" step="0.01"
                                                    ...
                                                    value="<?php echo e(old('incli_izquierda')); ?>">
                                                <label for="floatingInput">INCLI I</label>
                                                <?php if($errors->has('incli_izquierda')): ?>
                                                <span
                                                    class="error text-danger"><?php echo e($errors->first('incli_izquierda')); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="input-group mb-3" style="align-content: center">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" name="incli_derecha_1"
                                                    ...
                                                    value="<?php echo e(old('incli_derecha_1')); ?>">
                                                <label for="floatingInput">INCLI D-1</label>
                                                <?php if($errors->has('incli_derecha_1')): ?>
                                                <span
                                                    class="error text-danger"><?php echo e($errors->first('incli_derecha_1')); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="input-group mb-3" style="align-content: center">
                                            <div class="form-floating mb-3">
                                                <input type="number" class="form-control" step="0.01"
                                                    ...
                                                    value="<?php echo e(old('incli_izquierda_1')); ?>">
                                                <label for="floatingInput">INCLI I-1</label>
                                                <?php if($errors->has('incli_izquierda_1')): ?>
                                                <span
                                                    class="error text-danger"><?php echo e($errors->first('incli_izquierda_1')); ?></span>
                                                <?php endif; ?>
                                            </div>
                                    ...
                                    <div class="col-sm-12 col-md-2 col-lg-2" style="align-content: center">
                                        <div class="input-group mb-3" style="align-content: center">
                                            <div class="form-floating mb-3">
                                                ...
                                                <?php if($errors->has('intensidad_total')): ?>
                                                <span
                                                    class="error text-danger"><?php echo e($errors->first('intensidad_total')); ?></span>
                                                <?php endif; ?>
                                            </div>
...
</script><?php /**PATH C:\Apache248\htdocs\AppData\resources\views/TipoPrueba/luces.blade.php ENDPATH**/ ?>