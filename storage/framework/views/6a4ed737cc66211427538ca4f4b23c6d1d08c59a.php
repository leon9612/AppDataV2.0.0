        ...
        <div class="container">
            ...
            <div class="row" data-aos="fade-in">
                <div class="col-lg-12 mt-12 mt-lg-12 d-flex align-items-stretch">
                    <form action="<?php echo e(url('/frmotocarro')); ?>" method="POST" class="form-control">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="col-sm-12 col-md-1 col-lg-1" style="align-content: center">
                                <div class="mb-1">
                                    <input type="number" class="form-control" step="0.01" placeholder="Eje 2 iz"
                                        name="pesaje2i" id="pesaje2i" value="<?php echo e(old('pesaje2i')); ?>" style="width: 100%">
                ...
                <div class="col-sm-12 col-md-1 col-lg-1" style="align-content: center">
                    <div class="mb-1">
                        <input type="number" class="form-control" step="0.01" name="fuerza2i" id="fuerza2i"
                            placeholder="Eje 2 iz" value="<?php echo e(old('fuerza2i')); ?>">
                ...
                <div class="col-sm-12 col-md-1 col-lg-1" style="align-content: center">
                    <div class="mb-1">
                        <input type="number" class="form-control" step="0.01" name="fuerza2d" id="fuerza2d"
                            placeholder="Eje 2 dr" value="<?php echo e(old('fuerza2d')); ?>">
            ...
            <div class="col-sm-12 col-md-2 col-lg-2" style="align-content: center">
                <div class="mb-1">
                    <input type="number" class="form-control" step="0.01" name="fuerzaauxi" id="fuerzaauxi"
                        placeholder="Fuer aux iz" value="<?php echo e(old('fuerzaauxi')); ?>" style="width: 100%">
            ...
            <div class="col-sm-12 col-md-2 col-lg-2" style="align-content: center">
                <div class="mb-1">
                    <input type="number" class="form-control" step="0.01" name="fuerzaauxd" id="fuerzaauxd"
                        placeholder="Fuer aux dr" value="<?php echo e(old('fuerzaauxd')); ?>" style="width: 100%">
        ...
        <div class="col-sm-12 col-md-2 col-lg-2" style="align-content: center">
            <div class="mb-1">
                <input type="number" class="form-control" step="0.01" name="deseje2" id="deseje2"
                    placeholder="Des eje 2" value="<?php echo e(old('deseje2')); ?>" disabled>
            ...
            <div class="col-sm-12 col-md-2 col-lg-2" style="align-content: center">
                <div class="mb-1">
                    <input type="number" class="form-control" step="0.01" name="efiaux" placeholder="Eficacia auxiliar"
                        id="efiaux" value="<?php echo e(old('efiaux')); ?>" disabled>
            ...
            <div class="col-sm-12 col-md-2 col-lg-2" style="align-content: center">
                <div class="mb-1">
                    <input type="number" class="form-control" step="0.01" placeholder="Eficacia total" name="efitotal"
                        id="efitotal" value="<?php echo e(old('efitotal')); ?>" disabled>
...
</script><?php /**PATH C:\Apache248\htdocs\AppData\resources\views/TipoPrueba/frenomotocarro.blade.php ENDPATH**/ ?>