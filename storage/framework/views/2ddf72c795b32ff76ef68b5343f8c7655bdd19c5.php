        ...
        <div class="container">
            ...
            <div class="row" data-aos="fade-in">
                ...
                <div class="col-lg-12 mt-12 mt-lg-12 d-flex align-items-stretch">
                    <form action="<?php echo e(url('/lum')); ?>" method="POST" class="form-control">
                        <?php echo csrf_field(); ?>
                                                ...
                                                <div class="input-group" style="align-content: center">
                                                    <div class="form-floating" style="width: 100%;">
                                                        <input type="text" class="form-control" name="baja_derecha1"
                                                            ...
                                                            value="<?php echo e(old('baja_derecha1')); ?>">
                                                        <label for="baja_derecha1">BAJA 2</label>
                                                        <?php if($errors->has('baja_derecha1')): ?>
                                                        <span
                                                            class="error text-danger"><?php echo e($errors->first('baja_derecha1')); ?></span>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="input-group" style="align-content: center">
                                                    <div class="form-floating" style="width: 100%;">
                                                        <input type="text" class="form-control" name="baja_derecha2"
                                                            ...
                                                            value="<?php echo e(old('baja_derecha2')); ?>">
                                                        <label for="baja_derecha2">BAJA 3</label>
                                                        <?php if($errors->has('baja_derecha2')): ?>
                                                        <span
                                                            class="error text-danger"><?php echo e($errors->first('baja_derecha2')); ?></span>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="input-group" style="align-content: center">
                                                    <div class="form-floating" style="width: 100%;">
                                                        <input type="text" class="form-control" name="incli_derecha1"
                                                            ...
                                                            value="<?php echo e(old('incli_derecha1')); ?>">
                                                        <label for="incli_derecha1">INCLI 2</label>
                                                        <?php if($errors->has('incli_derecha1')): ?>
                                                        <span
                                                            class="error text-danger"><?php echo e($errors->first('incli_derecha1')); ?></span>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="input-group" style="align-content: center">
                                                    <div class="form-floating" style="width: 100%;">
                                                        <input type="text" class="form-control" name="incli_derecha2"
                                                            ...
                                                            value="<?php echo e(old('incli_derecha2')); ?>">
                                                        <label for="incli_derecha2">INCLI 3</label>
                                                        <?php if($errors->has('incli_derecha2')): ?>
                                                        <span
                                                            class="error text-danger"><?php echo e($errors->first('incli_derecha2')); ?></span>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                            </div>
...
</script><?php /**PATH C:\Apache248\htdocs\AppData\resources\views/TipoPrueba/lucesmotos.blade.php ENDPATH**/ ?>