        ...
        <div class="container">
            ...
            <div class="row" data-aos="fade-in">
                <div class="col-lg-12 mt-12 mt-lg-12 d-flex align-items-stretch">
                    <form action="<?php echo e(url('/tax')); ?>" method="POST" class="form-control">
                        <?php echo csrf_field(); ?>
                                    ...
                                    <div class="input-group mb-3" style="align-content: center">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" name="ref_llanta"
                                                id="ref_llanta" placeholder="1" value="<?php echo e(old('ref_llanta')); ?>">
                                            <label for="floatingInput">Referencia llanta</label>
                                            <?php if($errors->has('ref_llanta')): ?>
                                            <span
                                                class="error text-danger"><?php echo e($errors->first('ref_llanta')); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    ...
                                    <div class="input-group mb-3" style="align-content: center">
                                        <div class="form-floating mb-3">
                                            <input type="number" class="form-control" step="0.01"
                                                ...
                                                value="<?php echo e(old('err_tiempo')); ?>">
                                            <label for="floatingInput">Error tiempo</label>
                                            <?php if($errors->has('err_tiempo')): ?>
                                            <span
                                                class="error text-danger"><?php echo e($errors->first('err_tiempo')); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    ...
                                    <div class="input-group mb-3" style="align-content: center">
                                        <div class="form-floating mb-3">
                                            <input type="number" class="form-control" step="0.01"
                                                ...
                                                value="<?php echo e(old('err_distancia')); ?>">
                                            <label for="floatingInput">Error distancia</label>
                                            <?php if($errors->has('err_distancia')): ?>
                                            <span
                                                class="error text-danger"><?php echo e($errors->first('err_distancia')); ?></span>
                                            <?php endif; ?>
                                        </div>
...
</script><?php /**PATH C:\Apache248\htdocs\AppData\resources\views/TipoPrueba/taximetro.blade.php ENDPATH**/ ?>